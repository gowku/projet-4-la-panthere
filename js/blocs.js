...
function scrollToTarget(t) {
  1 == t
    ...
    : 2 == t
    ? (t = $(document).height())
    : ((t = $(t).offset().top), $(".sticky-nav").length && (t -= $(".sticky-nav .navbar-header").height())),
    $("html,body").animate(
      {
        scrollTop: t,
      },
  ...
  window.targetLightbox,
    ...
    $(document).on("click", ".next-lightbox, .prev-lightbox", function (t) {
      ...
      (targetLightbox = a),
        ...
        "no-gallery-set" == e
          ? ($("a[data-lightbox]").index(a) != $("a[data-lightbox]").length - 1 && $(".next-lightbox").show(),
            $("a[data-lightbox]").index(a) > 0 && $(".prev-lightbox").show())
          : ($('a[data-gallery-id="' + e + '"]').index(a) != $('a[data-gallery-id="' + e + '"]').length - 1 &&
              $(".next-lightbox").show(),
